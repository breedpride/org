...
@Component({
  ...
  selector: 'bp-terms-and-conditions',
  styles: ``,
  template: ` <div
    ...
    >
      ...
      <div class=" flex flex-col items-center justify-center pt-14 sm:pt-32">
        <div class="max-w-screen px-6 sm:px-10 md:max-w-6xl lg:px-0">
          ...
          >
            <div class="text-6xl md:text-7xl">Terms and conditions</div>
          </div>
          <div
            class=" sm:mt-22 relative mt-14 flex flex-col items-center justify-center space-y-10 rounded-2xl bg-white/50 p-8  text-xl"
          >
            <p class="leading-8">
...
export const TermsAndConditionsPage: Route = {
  loadComponent: () => TermsAndConditionsComponent,
