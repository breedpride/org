  ...
  template: `
    <div class="absolute inset-0">
      ...
      >
        ...
        <a
          class="text-primary-500 mt-12 font-medium underline"
          [routerLink]="['/']"
        >
          Back to Dashboard
        </a>
...
export const error500Page: Route = {
  loadChildren: () =>
    import('./error-500.routing').then((m) => m.error500Routes),
  path: '500-not-found',
  pathMatch: 'full',
};
